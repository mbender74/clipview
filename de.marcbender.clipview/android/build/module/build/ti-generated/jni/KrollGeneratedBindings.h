	...
	namespace bindings {
		...
		BindEntry* TiModuleBindings::lookupGeneratedInit(const char* name, unsigned int length) {
			static BindEntry binds[] = {
				{"de.marcbender.clipview.ClipViewProxy", ::de::marcbender::clipview::clipview::ClipViewProxy::bindProxy, ::de::marcbender::clipview::clipview::ClipViewProxy::dispose},
				{"de.marcbender.clipview.ClipViewModule", ::de::marcbender::clipview::ClipViewModule::bindProxy, ::de::marcbender::clipview::ClipViewModule::dispose}
			};
